...
consumer_key = os.getenv('TWITTER_CONSUMER_KEY','Twitter Consumer Key')
consumer_secret = os.getenv('TWITTER_CONSUMER_SECRET','Twitter Consumer Secret')
access_token = os.getenv('TWITTER_ACCESS_TOKEN','Twitter Access Token')
access_token_secret = os.getenv('TWITTER_ACCESS_SECRET','Twitter Access Token Secret')

twitter_credentials = {}
twitter_credentials['consumer_key'] = consumer_key
twitter_credentials['consumer_secret'] = consumer_secret
twitter_credentials['access_token'] = access_token
twitter_credentials['access_token_secret'] = access_token_secret
